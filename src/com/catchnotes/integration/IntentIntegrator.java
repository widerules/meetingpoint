...
import pl.skifo.meetingpoint.R;
...
public class IntentIntegrator {
    ...
    public void createNote(String title, String message, Location loc, boolean autoSave) {
        createNote(title, message, loc, 0, -1, autoSave, null, null, false);
    }
	...
	public void createNote(String message, Location location, long reminder, int cursorPosition, boolean autoSave, Uri mediaUri, String mimeType, boolean isVoiceNote) {
	    createNote(null, message, location, reminder, cursorPosition, autoSave, mediaUri, mimeType, isVoiceNote);
	}
	    
	public void createNote(String title, String message, Location location, long reminder, int cursorPosition, boolean autoSave, Uri mediaUri, String mimeType, boolean isVoiceNote) {
		...
		intent.putExtra(CatchIntent.EXTRA_SOURCE, "MeetingPoint"); // TODO: *** change this to your own source string! ***
		...
		intent.putExtra(CatchIntent.EXTRA_SOURCE_URL, "http://skifo.pl/");    // TODO: *** change this to your own source URL! ***
		...
		//    New note: <your title>
		//
		intent.putExtra(Intent.EXTRA_TITLE, (title != null)?title:"no title");			// TODO: *** change this to your own title (or leave the extra out) ***
